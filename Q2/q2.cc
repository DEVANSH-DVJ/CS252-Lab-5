 ...
 * Lab 5 - Question 2 - No Hidden Terminals
 */
...
void experiment(bool enableCtsRts, std::string wifiManager) {
  ...
  lossModel->SetDefaultLoss(50); // Set default loss to 50 dB - Good coverage
  ////////////////////////////////////////////////////////////////////////////////////
  ...
  std::string dataRate = "27.0Mbps"; // Only this should be manipulated
