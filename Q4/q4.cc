 ...
 * Lab 5 - Question 4 - Wi-fi Scenario 2
 */
...
void experiment(bool enableCtsRts, std::string wifiManager) {
  ...
  // set symmetric loss A <-> B, B <-> C, C <-> D to 50 dB, good coverage
  ...
  // OnOff source helpers - (A) to B, (C) to D
